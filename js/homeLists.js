...
async function getUpcomingList() {
    ...
    // MODAL QUICK VIEW
    let previewContainer = document.querySelector("#upcomingList-cards");
    let proviewBox = previewContainer.querySelectorAll(".modal");
    // SHOW MODAL
    document.querySelectorAll("#upcomingList-cards .cards-link").forEach(button => {
      button.onclick = () => {
        let name = button.getAttribute("data-name");
        proviewBox.forEach(modal => {
          let target = modal.getAttribute("data-target");
...
const displayUpcomingList = (upcomingList) => {
    ...
    upcomingList.forEach(movie => {
        ...
        upcomingListContainer.appendChild(cardMain);
...
async function getRatedList() {
    ...
    // MODAL QUICK VIEW
    let previewContainer = document.querySelector("#ratedList-cards");
    let proviewBox = previewContainer.querySelectorAll(".modal");
    // SHOW MODAL
    document.querySelectorAll("#ratedList-cards .cards-link").forEach(button => {
      button.onclick = () => {
        let name = button.getAttribute("data-name");
        proviewBox.forEach(modal => {
          let target = modal.getAttribute("data-target");
...
const displayRatedList = (ratedList) => {
    ...
    ratedList.forEach(movie => {
        ...
        ratedListContainer.appendChild(cardMain);
